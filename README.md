...
7. You'll now be presented with a TON of options. For the very first option (the base body), select SE 3BBB Body Amazing. After that, follow this priority list to select the correct options.
   1. SGSE or MDSE
   3. 3BA or C3BBB
   4. CBBE UUNP
   5. CBBE [SMP]
...
- SexLab Defeat: Alternate death mechanics that can result in NSFW activities. Also important to note that in this list Defeat is configured such that if you go down, everyone in your party goes down. 
